...
export default function Home() {
  return (
    <main className="min-h-screen bg-bg-primary text-text">
      ...
      <section className="relative min-h-screen flex items-center px-6 pt-16 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto w-full grid md:grid-cols-2 gap-16 items-center py-24">
          ...
          <div>
            ...
            <h1 className="text-6xl md:text-8xl font-black leading-[0.9] tracking-tight mb-8 font-hud">
      ...
      {/* Features */}
      <section id="features" className="py-32 px-6 border-t border-accent/10">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-4 mb-4">
            <p className="hud-label">System Architecture</p>
          </div>
          <h2 className="text-4xl md:text-5xl font-black text-text mb-20 leading-tight font-hud">
            Built for<br /><span className="text-text-dim">precision.</span>
          </h2>
      ...
      {/* Pricing */}
      <section id="pricing" className="py-32 px-6 border-t border-accent/10">
        <div className="max-w-6xl mx-auto">
          <p className="hud-label mb-4">Access</p>
          <h2 className="text-4xl md:text-5xl font-black text-text mb-20 font-hud">One license.<br /><span className="text-text-dim">No subscription.</span></h2>
      ...
      {/* How It Works */}
      <section className="py-32 px-6 border-t border-accent/10">
        <div className="max-w-6xl mx-auto">
          <p className="hud-label mb-4">Deployment</p>
          <h2 className="text-4xl md:text-5xl font-black text-text mb-20 font-hud">Four steps.<br /><span className="text-text-dim">Then nothing.</span></h2>
      ...
      {/* FAQ */}
      <section id="faq" className="py-32 px-6 border-t border-accent/10">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-20">
          <div>
            <p className="hud-label mb-4">FAQ</p>
            <h2 className="text-4xl md:text-5xl font-black text-text leading-tight font-hud">Questions<br /><span className="text-text-dim">answered.</span></h2>
          </div>
      ...
      <section className="py-32 px-6 border-t border-accent/10">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start md:items-end justify-between gap-12">
          <div>
            <p className="hud-label mb-6">Start Operating</p>
            <h2 className="text-5xl md:text-7xl font-black text-text leading-none font-hud">
              Ready<br />when<br /><span className="text-text-dim">you are.</span>
            </h2>
          </div>
          <Link href="/signup" className="btn-primary px-10 py-4 flex-shrink-0">
            CREATE ACCOUNT
          </Link>
        </div>
      </section>
      ...
      <footer className="border-t border-accent/10 py-8 px-6">
        <div className="max-w-6xl mx-auto flex justify-between items-center text-[10px] tracking-widest text-text-dim uppercase">
